const MarketingStrategy = () => {
  return (
    <div>
      ...
      <h1 className='text-7xl font-semibold text-primary mt-10'>
        ...
        {strategies.map(strategy => {
          return (
            <div className='border border-primary p-5 flex flex-col space-y-10 rounded transform hover:scale-105 duration-300'>
              <h1 className='mx-20 text-center -mt-8 bg-white border-primary border text-2xl rounded text-secondary py-2'>
                {strategy.title}
              </h1>
              <img src={strategy.image} alt='' className='h-24 w-24' />
